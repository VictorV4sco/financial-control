...
class CreditCardTransactionApiFlowIT {
	...
	void shouldCreateInstallmentTransactionAndDistributeItAcrossBills() {
		...
		Integer secondBillId = createBill(creditCardId, "2026-05-01", "2026-05-25", "2026-06-05");
		...
		.then()
				...
				.body("installmentCount", equalTo(2))
		...
		.then()
				...
				.body("[0].installmentPrice", equalTo(1500.0F))
		...
		.then()
				.statusCode(200)
				.body("[0].totalAmount", equalTo(1500.0F));
	...
	void shouldDeleteTransactionsWhenDeletingCreditCardByApi() {
		...
		Integer firstBillId = createBill(creditCardId, "2026-04-01", "2026-04-25", "2026-05-05");
		createBill(creditCardId, "2026-05-01", "2026-05-25", "2026-06-05");
